...
public:
     ...
     */
    static std::shared_ptr < ObiektGraficzny > Buduj(int w, PzG::LaczeDoGNUPlota * tmpp) { return fab.dodajObiekt(w, tmpp); }

    /*!
     * \brief Tworzy nową przeszkodę lub robota.
     */
    std::shared_ptr < ObiektGraficzny > dodajObiekt(int w, PzG::LaczeDoGNUPlota * tmpp);
